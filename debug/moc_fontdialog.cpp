...
QT_MOC_LITERAL(1, 11, 9), // "valueFont"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 4), // "size"
QT_MOC_LITERAL(4, 27, 15), // "emitFontChanged"
QT_MOC_LITERAL(5, 43, 20) // "emitFontChangedApply"

    },
    "FontDialog\0valueFont\0\0size\0emitFontChanged\0"
    "emitFontChangedApply"
};
...
void FontDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->valueFont((*reinterpret_cast< const int(*)>(_a[1]))); break;
        case 1: _t->emitFontChanged(); break;
        case 2: _t->emitFontChangedApply(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (FontDialog::*)(const int & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FontDialog::valueFont)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FontDialog::valueFont(const int & _t1)
{
