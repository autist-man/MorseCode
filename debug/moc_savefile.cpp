...
QT_MOC_LITERAL(1, 9, 12), // "saveFileEmit"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 12), // "emitSaveFile"
QT_MOC_LITERAL(4, 36, 10), // "makeFolder"
QT_MOC_LITERAL(5, 47, 12), // "removeFolder"
QT_MOC_LITERAL(6, 60, 11), // "funSaveFile"
QT_MOC_LITERAL(7, 72, 4) // "text"

    },
    "SaveFile\0saveFileEmit\0\0emitSaveFile\0"
    "makeFolder\0removeFolder\0funSaveFile\0"
    "text"
};
...
void SaveFile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->saveFileEmit(); break;
        case 1: _t->emitSaveFile(); break;
        case 2: _t->makeFolder(); break;
        case 3: _t->removeFolder(); break;
        case 4: _t->funSaveFile((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SaveFile::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SaveFile::saveFileEmit)) {
                *result = 0;
                return;
            }
        }
